...
<div class="section-block catch-up" markdown="0">
  ...
  <p>New book, fresh start. Before we crack it open, let's land together. Fire up the popcorn picker and — when it's your turn — share whatever feels right:</p>

  <ul>
    <li>How was your week — actually?</li>
    <li>Why this book, for you, right now? What pulled you in?</li>
...
<div class="section-block">
  ...
  <ul>
    ...
    <li>One thing you'll deliberately let go of (or not get to) this week.</li>
  </ul>
</div>
